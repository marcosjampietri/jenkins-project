...
exports.payIntent = exports.getAllProd = void 0;
...
var payIntent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var secretKey, stripe, amount, paymentIntent, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                secretKey = (process.env.STRIPE_SECRET_KEY);
                stripe = __webpack_require__(/*! stripe */ "stripe")(secretKey);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var express_1 = __importDefault(__webpack_require__(/*! express */ "express"));
var prodController_1 = __webpack_require__(/*! ../controllers/prodController */ "./src/controllers/prodController.ts");
var router = express_1.default.Router();
//CV-EDU
router.get("/products", prodController_1.getAllProd);
router.post("/payment_intents", prodController_1.payIntent);
